...
// File: src/contracts/ERC2981.sol
...
// File: src/contracts/erc721/ARM.sol
...
contract ARM is ERC721, ERC721Enumerable, 
        ERC721URIStorage, Pausable, AccessControl,
        ERC721Burnable {
    ...
    constructor() ERC721("ArtemisVisionMedia", "ARM") {
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(PAUSER_ROLE, msg.sender);
        _setupRole(MINTER_ROLE, msg.sender);
    }

    function safeMint(address to, string memory _tokenURI, Royalty[] memory _creatorRoyalties) public {
        ...
        for (uint256 index = 0; index < _creatorRoyalties.length; index++) {
            ...
            royalties[tokenId].push(Royalty(royalty.addr, royalty.percent));
        }
    ...
    //     return (royalty.addr, (value * _royaltiesValue) / 10000);
    // }
}
